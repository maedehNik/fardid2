<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Admin_OurClients.aspx.cs" Inherits="Fardid.Admin_OurClients" %>
                ...
                <div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="m_user_profile_tab_1">
                            <div class="m-form m-form--fit m-form--label-align-right" onsubmit="return false;" autocomplete="off">
                                <div class="m-portlet__body" style="padding-bottom: 0">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="container-fluid">
                                                <div class="m-section__content container-fluid tshtextright">
                                                    <button onclick="GotoUploader('NewPics',100,'NewPicsGroundGeneratedGal')" class="btn btn-brand btn-sm" type="button" data-target="#uploader" data-toggle="modal" style="margin-top: 15px;">انتخاب عکس</button>
                                                </div>
                                                <div>
                                                    <%foreach (var item in Models)
                                                        {%>

                                                    <div class="col-lg-2 selected-img-div" id="SelctdimgDIV-<%=item.PicId %>">
                                                        <div class="selected-pic" style="position: relative;">
                                                            <button type="button" class="btn btn-danger delete-selected-pic" onclick="return DeleteIMGOURCLIENT(<%=item.PicId %>)"  style="position: absolute; right: -8px; top: -10px; z-index: 999; padding: 4px 5px;"><i class="fa fa-trash"></i></button>
                                                            <img src="<%=item.ThumpnailPic %>" class="uimg" data-name="نام عکس" data-label="لیبل" data-desc="توضیحات" alt="">
                                                        </div>
                                                    </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_Scripts" runat="server">
    ...
    <script>
        ...
        function DeleteIMGOURCLIENT(id) {
            mApp.block(".m-page", {
                overlayColor: "#2c2e3e", type: "loader", state: "success", message: "در حال بارگزاری"
            });

            $.ajax({
                url: 'Admin_Ajax/DELETEClientsPic.aspx?idIMG=' + id,
                type: "post",
                contentType: "application/json; charset=utf-8",
