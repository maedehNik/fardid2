                        ...
                        e.format("YYYY-MM"),
                            ...
                            $("#m_calendar").fullCalendar( {
                                    ...
                                    , editable:!0, eventLimit:!0, navLinks:!0, defaultDate:moment("2017-09-15"), events:[ {
                                        ...
                                        , {
                                            title: "رفتن به گوگل", url: "http://google.com/", start: moment("2017-09-26"), className: "m-fc-event--solid-info m-fc-event--light", description: "Lorem ipsum dolor sit amet, labore"
                                        }
